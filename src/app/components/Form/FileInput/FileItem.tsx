...
const fileItem = tv({
  slots: {
    container:
      'group flex items-start gap-4 rounded-lg border border-zinc-200  dark:border-slate-600 p-4',
    icon: 'rounded-full border-4 border-violet-100 bg-violet-200 p-2 text-violt-600 dark:border-cyan-800 dark:bg-cyan-950 dark:text-cyan-300',
    deleteButton: '',
  },
  ...
  variants: {
    state: {
      ...
      error: {
        container: 'bg-error-25 bordr-error-300',
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="text-sm font-medium text-error-700 dark:text-cyan-300">
              Upload failed, pleease try again.
            </span>
            <span className="text-sm text-error-600 dark:text-cyan-500">
              {name}
            </span>
          </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-zinc-100  dark:bg-slate-700">
              <div
                className="h-2 rounded-full bg-violet-600 w-4/5 dark:bg-cyan-300"
